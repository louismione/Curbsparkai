...
const pricing = [
  ...
  },
  {
    ...
    price: "$19",
    sub: "per month",
    features: ["100 generations per month", "All 4 copy tools", "Brand memory on this device", "Copy-ready outputs", "Monthly calendars"],
    cta: "Start Starter",
  },
  {
    name: "Pro",
    price: "$49",
    sub: "per month",
    features: ["Unlimited generations", "Promo bundles", "Review recovery responses", "Brand memory on this device", "Monthly calendars"],
    cta: "Start Pro",
    highlight: true,
  },
  {
    ...
    price: "$99",
    sub: "per month",
    features: ["Unlimited generations", "Multiple business locations", "Team-ready usage", "Brand memory on this device", "Monthly marketing calendars"],
    cta: "Start Business",
  },
];
